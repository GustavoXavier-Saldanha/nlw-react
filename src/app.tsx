...
export function App() {
  ...
  function removeEmailFromInvites(email: string) {
    const data = emailsToInvite.filter((e) => e !== email);
      ...
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-zinc-300 text-lg">
            Convide seus amigos e planeje sua próixima viajem!
          </p>
        </div>
          ...
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                type="text"
                placeholder="Quando?"
                className="bg-transparent placeholder-zinc-400 text-lg outline-none w-40"
              />
            </div>
            ...
            <form
              ...
              <div className="flex items-center gap-2 flex-1">
                ...
                <input
                  ...
                  className="bg-transparent placeholder-zinc-400 text-lg outline-none w-40 flex-1"
                />
              </div>
              <button
                type="submit"
